...
public final class CoberturaPublisherTarget {
	 ...
	 * @stapler-constructor
	 */
	public CoberturaPublisherTarget(final CoverageMetric metric, final Integer healthy, final Integer unhealthy,
			final Integer unstable) {
		this.metric = metric;
	 ...
	 * 
	 * @param metric
	 *            Value to set for property 'metric'.
	 */
	 ...
	 * 
	 * @param healthy
	 *            Value to set for property 'healthy'.
	 */
	public void setHealthy(final Integer healthy) {
		this.healthy = healthy;
	}
	 ...
	 * 
	 * @param unhealthy
	 *            Value to set for property 'unhealthy'.
	 */
	public void setUnhealthy(final Integer unhealthy) {
		this.unhealthy = unhealthy;
	}
	 ...
	 * 
	 * @param unstable
	 *            Value to set for property 'unstable'.
	 */
	public void setUnstable(final Integer unstable) {
		this.unstable = unstable;
	}
